...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,YAAY;AAChB;;AAEA;;AAEA","sourcesContent":[".projectBox {\n    border: 1px solid blue;\n    margin: 10px;\n}\n\n.todoBox {\n    \n}"],"sourceRoot":""}]);
// Exports
...
const defaultToDo = ToDo('groceries', 'get milk', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date('2023-12-08'), "yyyy-MM-dd"), 'high');
const ToDo1 = ToDo('eat', 'eat dinner', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date('2023-12-09'), "yyyy-MM-dd"), 'low');
const ToDo2 = ToDo('run', '3 miles', (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(new Date('2023-12-10'), "yyyy-MM-dd"), 'medium');
